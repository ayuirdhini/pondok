...
<head>
    ...
    <title>SIPON | Panitia</title><!--begin::Primary Meta Tags-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="../kepala-ponpes/dashboard.php" class="brand-link"> <!--begin::Brand Image--> <img src="../../dist/assets/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light">Panitia</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item"> <a href="../kepala-ponpes/dashboard.php" class="nav-link"> <i class="nav-icon bi bi-house"></i>
                            <p>Dashboard</p>
                        </a> </li>
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-pencil-square"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="../panitia/data-santri.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Data Diri Santri</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="../panitia/data-kk-santri.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Data KK Santri</p>
                                    </a> </li>
                                    <li class="nav-item"> <a href="../panitia/hasil-seleksi.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Hasil Seleksi</p>
                                    </a> </li>
