...
<head>
    ...
    <title>SIPON | Kepala Ponpes</title><!--begin::Primary Meta Tags-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-pencil-square"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="../kepala-ponpes/data-santri.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Data Diri Santri</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="../kepala-ponpes/data-kk-santri.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Data KK Santri</p>
                                    </a> </li>
                            </ul>
                        </li>
