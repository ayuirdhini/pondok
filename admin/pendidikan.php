        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="form-tambah-pendidikan.php"><button class="btn btn-success"><i class="fas fa-plus"></i> Tambah Data</button></a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                        ...
                        ?>
                            ...
                            <td>
                                <a href="form-edit-pendidikan.php?op=edit&id_pendidikan=<?php echo $row['id_pendidikan'] ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
