...
<main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Status Kepala Keluarga</h3>
                        </div>
                        <div class="col-sm-6">
      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Tabel Status Kepala Keluarga</h3>
            <div class="card-tools">
              <a href="form-tambah-status-kepkel.php"><button class="btn btn-success"><i class="fas fa-plus"></i> Tambah Data</button></a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                        ...
                        ?>
                            ...
                            <td>
                                <a href="form-edit-status-kepkel.php?op=edit&id_statusKK=<?php echo $row['id_statusKK'] ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
