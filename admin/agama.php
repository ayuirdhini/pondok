        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="form-tambah-agama.php"><button class="btn btn-success"><i class="fas fa-plus"></i> Tambah Data</button></a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM agama ORDER BY nama_agama ASC";
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="form-edit-agama.php?op=edit&id_agama=<?php echo $row['id_agama'] ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
